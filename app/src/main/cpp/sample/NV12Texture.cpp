...
void NV12Texture::LoadFrame(AVFrame *frame) {
    if (frame->data) {
...
void NV12Texture::Init() {
    ...
    yuv_ProgramObj = GLUtils::CreateProgram(vShaderStr, nv12ShaderStr);
...
void NV12Texture::Draw(int screenW, int screenH) {
